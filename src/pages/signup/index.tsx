          ...
          <div className="w-[70%]">
            <div className="flex flex-col items-center gap-5">
              ...
              <div className="flex flex-col items-center gap-y-5 w-full">
                <input type="text" name="" id="" className="w-full px-4 py-2" placeholder="Username or Email Address" required/>
                <input type="password" name="" id="" className="w-full px-4 py-2" placeholder="Password" required/>
                <span className="descr-1 flex justify-start w-full text-primary cursor-pointer text-xs font-medium">Forgot Password?</span>
                <button type="submit" className="viewallbtn w-full">Sign Up</button>
              </div>
            </div>
          </div>
        </div>
