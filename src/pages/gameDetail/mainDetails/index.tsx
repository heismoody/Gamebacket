        ...
        <div className="flex flex-col gap-y-5 w-[65%] relative">
          ...
          <div>
            ...
            <p className="descr-1">
              ...
              consequatur? Nesciunt ex quibusdam magnam ut, praesentium quae,
              tempore cumque aspernatur asperiores consectetur provident nemo,
              quidem consequatur illo dolor earum nostrum fugiat neque mollitia!
              Earum.
            </p>
          </div>
          <div className="flex justify-between">
