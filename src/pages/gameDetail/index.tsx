...
export default function GameDetail({ ...props }: IgameDetails) {
  return (
        ...
        <div className="w-[1161px]">
            ...
            <div className="flex flex-col gap-y-5 w-[65%]">
              ...
              <div>
                ...
                <p className="descr-1">
                  ...
                  Cupiditate harum officia vel assumenda aliquam ipsam
                  dignissimos sit quas atque eaque, ipsum nesciunt debitis
                  delectus perferendis consequatur? Nesciunt ex quibusdam magnam
                  ut, praesentium quae, tempore cumque aspernatur asperiores
                  consectetur provident nemo, quidem consequatur illo dolor
                  earum nostrum fugiat neque mollitia! Earum.
                </p>
              </div>
              <div className="flex justify-between">
                <div className="flex flex-col gap-y-2">
                  <span className="flex items-center gap-x-2">
                    <span className="introheading-2 text-sm">
                      Release date:
                    </span>
                ...
                <div className="flex flex-col gap-y-2">
                  <span className="flex items-center gap-x-2">
                    ...
                    <span className="descr-1 text-[13px]">https://www.callofduty.com/modernwarfare2</span>
                  </span>
                  <span className="flex items-center gap-x-2">
                    <span className="introheading-2 text-sm">Tags:</span>
                    <span className="descr-1 text-[13px]">Singleplayer, Steam Achievements, Multiplayer</span>
                  </span>
                  <span className="flex items-center gap-x-2">
                    <span className="introheading-2 text-sm">Age rating:</span>
                    <span className="descr-1 text-[13px]">Not rated</span>
          ...
          <div>
            <div className="descr-1 flex-row border border-submessage w-fit rounded py-2 px-3 divide-x-[1px] divide-submessage font-semibold cursor-pointer">
              <span className="px-4 text-primary">Requirements</span>
              <span className="px-5">Reviews (0)</span>
            </div>
            <div className="flex flex-col gap-y-3">
              ...
              <ul className="descr-1 text-xs list-inside list-disc">
                ...
                <li>
                  Processor: Intel® Core™ i3-6100 / Core™ i5-2500K or AMD Ryzen™
                  3 1200
                </li>
