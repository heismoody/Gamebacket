...
import ConnectWithUs from "./newRelease/connectWithUs/connectWithUs";
    ...
    <NavigationBar/>
      <section className="flex flex-col items-start justify-center bg-slate-500">
        <div className="w-[45%] px-10">
          <strong className="text-5xl">WATCH DOGS</strong>
          <p className="text-base py-5">
            Welcome to Watch Dogs, where technology is your ultimate weapon and
            the city of the future is yours to command. Immerse yourself in this
            thrilling action-adventure game that blurs the lines between reality
            and virtuality, offering a truly unparalleled gaming experience.
          </p>
