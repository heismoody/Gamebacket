  ...
  return (
    <div className="flex bg-background h-screen">
      <div className="flex flex-col py-5 gap-5 items-center w-[20%] my-3">
        ...
        <div className="w-full">
          <ul className="flex justify-center text-white font-bold text-base">
            <div className="flex flex-col items-end w-full">
              <li className="flex items-center gap-10 bg-slate-900 w-[90%] px-8 py-3 rounded-l-2xl">
                <svg
        ...
        <div className="h-full flex items-end gap-6 cursor-pointer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
            viewBox="0 0 512 512"
            className="w-6 h-6 fill-submessage"
          >
            <path d="M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 192 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l210.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128zM160 96c17.7 0 32-14.3 32-32s-14.3-32-32-32L96 32C43 32 0 75 0 128L0 384c0 53 43 96 96 96l64 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-64 0c-17.7 0-32-14.3-32-32l0-256c0-17.7 14.3-32 32-32l64 0z" />
          </svg>
          <span className="introheading-2 text-base text-submessage">Log Out</span>
        </div>
      </div>
      <div className="w-[80%] bg-slate-900 my-3 mr-3 rounded-2xl">
        <Dashboard />
      </div>
    </div>
  );
