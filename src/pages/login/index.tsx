      ...
      <div className="w-[50%] mobile:w-full flex justify-center items-center h-screen bg-[url('/login-bg.png')] bg-cover bg-no-repeat">
        <div className="w-[70%] mobile:w-[80%]">
          <div className="flex flex-col items-center gap-5">
            ...
            <span
              className={`introheading-2 leading-[3.75rem] mobile:text-3xl`}
            >
              Customer Login
            </span>
            <div className="flex flex-col gap-y-5 w-full">
              <form onSubmit={handleSubmit(onsubmit)} className=" flex flex-col items-center gap-y-5 ">
                <input
                {...register('username')}
                  type="text"
                  id=""
                ...
                <button type="submit" className="viewallbtn w-full py-2">
                  Sign In
                </button>
              </form>
